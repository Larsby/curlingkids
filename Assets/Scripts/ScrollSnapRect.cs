...
public interface ScrollSnapItemChanged {
...
public class ScrollSnapRect : MonoBehaviour, IBeginDragHandler, IEndDragHandler, IDragHandler {
	...
	public MonoBehaviour scrollSnapItemChangedListener = null;
	private ScrollSnapItemChanged ssic = null;
	...
	void Start() {
		...
		if (scrollSnapItemChangedListener != null)
			ssic = scrollSnapItemChangedListener as ScrollSnapItemChanged;

		if (ssic != null)
			startingPage = ssic.GetStartPage ();
	...
	private void NotifyListener(int index) {
		if (scrollSnapItemChangedListener != null) {
			ScrollSnapItemChanged ssic = scrollSnapItemChangedListener as ScrollSnapItemChanged;
			if (ssic != null)
				ssic.NotifyItemChanged (index);
		}
	}
	...
	private void SetPage(int aPageIndex) {
		...
		if (ssic != null)
			ssic.NotifyItemChanged (aPageIndex);
	}
	...
	private void SetPageSelection(int aPageIndex) {
		...
		if (unselectedPage == null || selectedPage == null)
			return;
